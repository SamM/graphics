(function(scope){
    ...
    (function(instance){
        instance.getAttrs = function(parent){
            ...
            for(var attr in this.attrs){
                ...
                if(typeof value == "string"){
                    if(value[0] == "+"){
                        attrs[attr] = parseFloat(!!attrs[attr]?attrs[attr]:0) + parseFloat(value.slice(1));
                    }else if(value[0] == "-"){
                        attrs[attr] = parseFloat(!!attrs[attr]?attrs[attr]:0) - parseFloat(value.slice(1));
                    }else if(value[0] == "*"){
                        attrs[attr] = parseFloat(!!attrs[attr]?attrs[attr]:0) * parseFloat(value.slice(1));
        ...
        instance.moveBy = function(x,y,z){
            ...
            var attrs = this.attrs;
            this.attrs.x = attrs.x + x;
            this.attrs.y = attrs.y + y;
            this.attrs.z = attrs.z + z;
            return this;
        };
        ...
        instance.toString = function(){
            return Variable.prototype.toString.call(this.attrs, 1);
        };
    }).call(Point.prototype, Point.prototype);
